...
try {
    ...
    console.log("🌍 Connected to the Avatar DB")
} catch {
...
let cc = Config.sessionName.replace(/Avatar;;;/g, "");
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://Avatarbot.tech/wiki')
	}
    }
    main()
    //========================================================================================================================================
...
app.listen(port, () => console.log(`Avatar Server listening on port http://localhost:${port}!`));
